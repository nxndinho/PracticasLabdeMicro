...
#DEFINE SW1 SWFLAGS,0
#DEFINE SW2 SWFLAGS,1
#DEFINE SW3 SWFLAGS,2
#DEFINE SW4 SWFLAGS,3
#DEFINE SW_OK SWFLAGS,4
#DEFINE SW_NOTRELEASED SWFLAGS,5
#DEFINE SW_HOLD SWFLAGS,6
...
void DET_BTNS(){ //Rutina para detectar pulsaciones de botones
   ...
   if(bit_test(PORTA, 0) != 0 || bit_test(PORTA, 1) != 0 || bit_test(PORTA, 2) != 0 || bit_test(PORTA, 3) != 0){ 
